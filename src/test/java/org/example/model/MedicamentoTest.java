...
class MedicamentoTest {
    ...
    void testGettersAndSetters() {
        ...
        assertEquals("400mg", med.getDosis());
    ...
    void testConstructores() {
        ...
        Medicamento medLombok = new Medicamento("id1", "Aspirina", 1000.0, 1200.0, "desc", "url", "img", "farm", "100mg");
        ...
        Medicamento medCustom = new Medicamento("id2", "Paracetamol", "500mg", "desc2", 2000.0, 2200.0, "url2", "farm2");
    ...
    void testEqualsAndHashCode() {
        ...
        Medicamento med1 = new Medicamento("id1", "Aspirina", "100mg", "desc", 1000.0, 1200.0, "url", "farm");
        Medicamento med2 = new Medicamento("id1", "Aspirina", "100mg", "desc", 1000.0, 1200.0, "url", "farm");
        // Y uno diferente
        Medicamento med3 = new Medicamento("id2", "Ibuprofeno", "200mg", "desc2", 2000.0, 2200.0, "url2", "farm2");
